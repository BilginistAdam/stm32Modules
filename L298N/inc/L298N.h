...
//DEFINE
//@L298N_MOTOR_SPEED
#define L298N_MOTOR_SPEED_MIN 		0						//This is min speed for each motors.
#define L298N_MOTOR_SPEED_MAX		100						//This is max speed for each motors.
#define L298N_MOTOR_SPEED_STOP 		0						//This is stop speed for each motors.
...
//Function Prototype
L298N_StatusTypeDef L298N_MotorInit(L298N_MotorHandler_t motor);
